...
/*
Fonction: couleurs_set
Description: Specifie une style, une couleur de fond et une couleur d'avant-plan pour les caracteres affiches dans la console.
Paramètres:
    - style : le style de caractere.
    - fColor : la coucleur d'avant-plan.
    - bColor : la couleur d'arriere-plan.
Retour: Aucun.
...
/*
Fonction: couleurs_reset
Description: Remet les valeurs par defaut pour le style, la couleur d'avant-plan et la couleur d'arriere-plan pour les caracteres affiches dans la console.
Paramètres: Aucun.
Retour: Aucun.
Paramètres modifiés: Aucun.
*/
